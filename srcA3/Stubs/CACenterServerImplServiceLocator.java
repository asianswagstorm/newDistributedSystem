...
public class CACenterServerImplServiceLocator extends org.apache.axis.client.Service implements Stubs.CenterServerImplService {

    public CACenterServerImplServiceLocator() {
    }


    public CACenterServerImplServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public CACenterServerImplServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for CenterServerImpl
    private java.lang.String CenterServerImpl_address = "http://localhost:8888/CenterServerImpl/CA?wsdl";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Stubs.CenterServerImpl.class.isAssignableFrom(serviceEndpointInterface)) {
