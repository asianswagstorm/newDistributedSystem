...
public class USCenterServerImplServiceLocator extends org.apache.axis.client.Service implements Stubs.CenterServerImplService {

    public USCenterServerImplServiceLocator() {
    }


    public USCenterServerImplServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public USCenterServerImplServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for CenterServerImpl
    private java.lang.String CenterServerImpl_address = "http://localhost:8888/US";
