...
@WebService(endpointInterface = "CenterServer")
public class CenterServerImplWS implements CenterServer,  Runnable{
	...
	public CenterServerImplWS(Server_ID serverID) throws Exception {
		super();
		CenterServerImplWS.ErecordID=0;
		CenterServerImplWS.MrecordID=0;
		this.recordsCount = 0;
	...
	public void setMRecordID(int MrecordID) {
	 ...
	 @WebMethod(operationName = "createMRecord", action = "urn:CreateMRecord")
	@Override
	public String createMRecord(String managerID, String firstname, String lastname, String employeeID, String emailID,
	 ...
	 @WebMethod(operationName = "createERecord", action = "urn:CreateERecord")
	@Override
	...
	public synchronized String getRecordCounts(String managerID) {                                      //socket
	 ...
	 @WebMethod(operationName = "editRecord", action = "urn:EditRecord")
	@Override
	public boolean editRecord(String managerID, String recordID, String fieldName, String newValue) {
	 ...
	 @WebMethod(operationName = "printAllData", action = "urn:PrintAllData")
	@Override
	public String printAllData()  {
	 ...
	 @WebMethod(operationName = "transferRecord", action = "urn:TransferRecord")
	@Override
	...
	private String transferERecord(String ServerToTransfer, String managerID, String recordID, String firstName, String lastName, String employeeID, String email, String projectID) {
	 ...
	 @WebMethod(operationName = "printRecord", action = "urn:PrintRecord")
	@Override
	...
	@WebMethod(operationName = "run", action = "urn:Run")
	public void run() {
		DatagramSocket datagramSocket = null;
