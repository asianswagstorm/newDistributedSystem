...
public class ManagerClient  {
	...
	public static void singleThread() throws Exception{
		...
		DEMS demsServer = DEMSHelper.narrow(namingContextRef.resolve_str(serverID.name()));
		do {
			...
			case 6:
				...
				demsServer = DEMSHelper.narrow(namingContextRef.resolve_str(serverID.name()));
	...
	public void createERecord(DEMS demsServer) {
	...
	public void editRecord(DEMS demsServer) {
	...
	public void getRecordCount (DEMS demsServer) {
	...
	public void transferRecord (DEMS demsServer) {
