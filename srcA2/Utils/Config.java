...
public class Config {
    ...
    public static final String TRANSFER_MANAGER_RECORD = "transferMRecord: %s transfered record ID: %s Name = %s %s, EmployeeID = %s, Email = %s,ProjectInfo = %s, In Location = %s";
    public static final String TRANSFER_EMPLOYEE_RECORD = "transferERecord: %s transfered record ID: %s Name = %s %s, EmployeeID = %s, Email = %s,ProjectID = %s";
