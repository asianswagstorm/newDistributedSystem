...
public class Config {
    ...
    // Logging
    public static final String LOG_SERVER_FILENAME = "/Users/Andy/Desktop/RMILOGS/SOEN423/Server_Log_File.log";
    public static final String LOG_MANAGER_CA_FILENAME = "/Users/Andy/Desktop/RMILOGS/SOEN423/Manager_CA_ID=%s.log";
    public static final String LOG_MANAGER_US_FILENAME = "/Users/Andy/Desktop/RMILOGS/SOEN423/Manager_US_ID=%s.log";
    public static final String LOG_MANAGER_UK_FILENAME = "/Users/Andy/Desktop/RMILOGS/SOEN423/Manager_UK_ID=%s.log";
    public static final String LOG_MODIFIED_RECORD_SUCCESS = "Modified record: ID = %s, FieldName = %s, Value = %s";
    public static final String LOG_NEW_EMPLOYEE_MODIFIED_RECORD = "Updated records: ID = %s, Name = %s %s, EmployeeID = %s, Email = %s,ProjectID = %s"; 
    public static final String LOG_NEW_MANAGER_MODIFIED_RECORD = "Updated records: ID = %s, Name = %s %s, EmployeeID = %s, Email = %s,ProjectInfo = %s, Location = %s"; 
    public static final String LOG_NEW_MODIFIED_RECORD = " Updated records: ID = %s, Name = %s %s, EmployeeID = %s"; 
    public static final String LOG_MODIFIED_RECORD_FAILED = " No record found: ID = %s, FieldName = %s, Value = %s";
    public static final String LOG_ADD_MANAGER_RECORD = " \n Added record: ID = %s, Name = %s %s, EmployeeID = %s, Email = %s, ProjectInfo = %s, Location = %s";
    public static final String LOG_ADD_EMPLOYEE_RECORD = " \n Added record: ID = %s, Name = %s %s, EmployeeID = %s, Email = %s,ProjectID = %s";
