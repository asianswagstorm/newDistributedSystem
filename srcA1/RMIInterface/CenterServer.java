...
public interface CenterServer extends Remote{
	...
	public String createMRecord(String firstname, String lastname,String employeeID ,String emailID ,ArrayList<String> projectInfo ,String location) throws RemoteException, ServerNotActiveException;
